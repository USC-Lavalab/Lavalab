...
const HomePage = () => {
  return (
    <div className="page">
            ...
            <Masthead>
              <MastheadTextTile>
                <h1 className="hero-header tile-title">
                  Our Spring 2024 Applications are live
                </h1>
                ...
                {
                  <a
                    href="https://docs.google.com/forms/d/e/1FAIpQLSfTB-BtXLbAE_wAL79omWcBLKisd0FcTFCbt8ALGjydMkVY0g/viewform?usp=sf_link"
                    target="_blank"
                  >
                    <div
                      style={{
      ...
      <ImageHero
        background={Fall2018BeachBonfire}
        height="800"
      >
      ...
      <ContentContainer>
        <TileRow id="alumni">
          <ContentTile title="Alumni Project Spotlight">
            <Carousel titles={["CarbonLink", "Fleek", "Kyoku"]}>
              <CarouselSlide>
                <h1>CarbonLink</h1>
                <p>
                  Access carbon markets. CarbonLink is the simple and secure
                  platform to buy, sell, and manage carbon offsets on the
                  blockchain.
                </p>
                <a href="https://www.carbonlink.io/">
                  https://www.carbonlink.io/
                </a>
              </CarouselSlide>
              <CarouselSlide>
                <h1>Fleek</h1>
                <p>
                  Your style, on Fleek. Explore curated items, search across top
                  women's clothing brands, save favorites, organize Fleek
                  boards, and purchase items.
                </p>
          ...
          <EmploymentTile
            title="Alumni Industry Employment"
            theme="dark"
          >
            <EmploymentContent>
            ...
            <ExecutiveBoard>
              <div className="member">
                ...
                <div className="description">
                  ...
                  <div className="description-inner">
                    <a
                      href="https://www.linkedin.com/in/maanya-kashyap/"
                      target="_blank"
                      rel="noopener noreferrer"
              ...
              <div className="member">
                ...
                <div className="description">
                  ...
                  <div className="description-inner">
                    <a
                      href="https://www.linkedin.com/in/capramana/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="linkedInLinks"
                    >
              ...
              <div className="member">
                ...
                <div className="description">
                  ...
                  <div className="description-inner">
                    <a
                      href="https://www.linkedin.com/in/kelciefan/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="linkedInLinks"
                    >
              ...
              <div className="member">
                ...
                <div className="description">
                  <img
                    className="eboard-icon"
                    src={IndustrySponsorshipsIcon}
                    alt=""
                  />
                  <div className="description-inner">
                    <a
                      href="https://www.linkedin.com/in/reagan-meek/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="linkedInLinks"
                    >
                    ...
                    <p className="eboard-title">
                      Director of Industry & Sponsorships
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="member">
                ...
                <div className="description">
                  ...
                  <div className="description-inner">
                    <a
                      href="https://www.linkedin.com/in/hilarifan/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="linkedInLinks"
                    >
                    ...
                    <p className="eboard-title">
                      Director of External Community
                    </p>
                  </div>
                </div>
              </div>
              <div className="member">
                ...
                <div className="description">
                  ...
                  <div className="description-inner">
                    <a
                      href="https://www.linkedin.com/in/allisonnakajima/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="linkedInLinks"
                    >
              ...
              <div className="member">
                ...
                <div className="description">
                  ...
                  <div className="description-inner">
                    <a
                      href="https://www.linkedin.com/in/jaden-young/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="linkedInLinks"
                    >
